...
#pros_count=opinions.pros.map(lambda p:False if len(p)==0 else True)
#ons_count=opinions.pros.map(lambda c:False if len(c)==0 else True)
...
print(f'''Dla produtu o kodzie{product_code} 
